...
- *International Max Planck Research School on Biology and Computation*, Freie Universitat Berlin + Max Planck Institute for Molecular Genetics.
...
- *Graduate program in Mathematical Sciences*, UNAM
...
* Python (8 years)
Focus on machine learning (PyTorch, Scikit-learn, Triton) and Scientific Computing
(Numpy, Scipy, Matplotlib)
* Julia (4 years)
* C/C++ (3 years)
Experience with advanced object-oriented design, polymorphism and concurrency.
* Javascript (2 year)
* Linux (6 years)
